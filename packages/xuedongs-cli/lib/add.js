...
async function add(name) {
  ...
  pkg.devDependencies[`@xuedongs/cli-plugin-${name}`] = "~1.0.0";
  ...
  let answers = {};
  try {
    const pluginPrompts = require(`@xuedongs/cli-plugin-${name}/prompts`);
  ...
  require(`@xuedongs/cli-plugin-${name}/generator`)(generator, answers);
